...
%%%%%%%%%%%%%%%%%%%%%% INTRO TODOS %%%%%%%%%%%%%%%%%%%%%%
\todo{Center around key goal of representing all error states}
\todo{Briefly discuss users being core to the blame process to segue into the feedback loop in next section}
\todo{Reassess discussion of bidirectional typing to make sure it doesn't overlap with background}

\subsection{User Interaction}

\todo{Key Goal: Determine blame from its ground truth: user decision. Have a user feedback loop and augment ability to make decisions by presenting all possible error states. Use this to segue into discussion of possible type sets}
...
\todo{Discussion of equivalence, consistency, and the constraint relation more properly}
...
\todo{Move this out of the appendix and discuss it properly here}
