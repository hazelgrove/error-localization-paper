...
The first step is constraint generation. Our approach closely follows the usual approach \cite{TAPL}, by augmenting the bidirectional type system for the marked lambda calculus with generated constraint sets, $C$. The new judgement forms are 
