...
Take the following \Hazel programs extended with type hole inference as examples: \todo{update screenshots to a more incremental flow and discuss it accordingly in narrative style}
...
\todo{After the marked pair section is done, type up the rules Raef has written for pair syn/ana constraints}
