...
This paper addresses this problem, contributing the first comprehensive formal account of type error localization and recovery: the marked lambda calculus. In particular, we define a gradual type system for expressions with marked errors, together with a total procedure for marking unmarked expressions with holes. We mechanize the metatheory of the marked lambda calculus in Agda and implement it, scaled up, as the new basis for Hazel, a full-scale live functional programming environment. 
