...
essential idea and introduce a general pattern that language designers can employ to created mark
...
We have implemented a marking system based on the marked lambda calculus as the foundation for a new version of the Hazel. % TODO citation and explain what in the world Hazel is (reviewer A stated that the lack of this made this section pretty much impossible to understand)
