...
The marked lambda calculus is based on the gradually typed lambda calculus \cite{Siek06a}\todo{snapl} extended
with numbers and booleans and empty expression holes. The syntax is given in
...
\subsection{Polymorphism and Judgemental Structure}
