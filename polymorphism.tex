...
Type classes present a symmetric alternative where the operands may stay in analytic mode.
With either approach, the necessary error marks and localization decisions may be arrived at by considering the possible failure cases.
