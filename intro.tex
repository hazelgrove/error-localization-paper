...
If localization assumes that the \li{then} branch is correct, then \li{x : Int} and there is no error to report for the left operand.
...
There is no definitive type or binding error here, based on the incomplete information available about \li{x}'s type, 
