...
we briefly discuss in Sec.~\ref{sec:calculus-hazelnut} how (1)  total marking can resolve the problem of undefined editing behavior in the Hazelnut structure editor calculus, 
