...
\newcommand{\synOrAna}{\ensuremath{\Rightarrow\hspace{-4pt}/\hspace{-1pt}\Leftarrow}}
\newcommand{\ctxSynOrAnaType}[3]{\ensuremath{\withCtx{#1}{\ensuremath{#2 \synOrAna #3}}}}

% patterns
\newcommand{\ctxSynPat}[3]{\ensuremath{\withCtx{#1}{\synType{#2}{#3}}}}
\newcommand{\ctxAnaPat}[4]{\ensuremath{\withCtx{#1}{\anaType{#2}{#3 ; #4}}}}
\newcommand{\notAnaPat}[2]{\ensuremath{#1 \not\Leftarrow #2}}
\newcommand{\ctxNotAnaPat}[4]{\ensuremath{\withCtx{#1}{\notAnaPat{#2}{#3 ; #4}}}}
...
\newcommand{\ctxAnaFixedIntoPat}[5]{\ensuremath{\withCtx{#1}{\anaFixedInto{#2}{#3}{#4 ; #5}}}}
...
\newcommand{\MRInconBr}{\ensuremath{\mathsmaller{\noJoinRel}}}
...
% errors with id
\newcommand{\ECMarkedId}[3]{\ensuremath{\textcolor{red}{\bm{\llparenthesis}}#1\textcolor{red}{\bm{\rrparenthesis}^{#3}_{#2}}}}
\newcommand{\ECMarkedUnboundId}[2]{\ensuremath{\ECMarkedId{#1}{\MRUnbound}{#2}}}
...
\newcommand{\ECUnboundId}[2]{\ensuremath{\ECMarkedUnboundId{#1}{#2}}}
...
% \newcommand{\ECInconMatchedId}[2]{\ensuremath{\ECMarkedId{#1}{#2}}}
