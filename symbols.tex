...
\newcommand{\anaTypeM}[2]{\ensuremath{#1 \Leftarrow #2}}
\newcommand{\notAnaTypeM}[2]{\ensuremath{#1 \not\Leftarrow #2}}
...
\newcommand{\ctxSynPatU}[3]{\ensuremath{\withCtxU{#1}{\synTypeU{#2}{#3}}}}
\newcommand{\ctxAnaPatU}[4]{\ensuremath{\withCtxU{#1}{\anaTypeU{#2}{#3 \dashv #4}}}}
\newcommand{\notAnaPatU}[2]{\ensuremath{#1 \not\Leftarrow #2}}
\newcommand{\ctxNotAnaPatU}[4]{\ensuremath{\withCtxU{#1}{\notAnaPatU{#2}{#3 \dashv #4}}}}

% marked pattern typing
\newcommand{\ctxSynPatM}[3]{\ensuremath{\withCtxM{#1}{\synTypeM{#2}{#3}}}}
\newcommand{\ctxAnaPatM}[4]{\ensuremath{\withCtxM{#1}{\anaTypeM{#2}{#3 \dashv #4}}}}
\newcommand{\notAnaPatM}[2]{\ensuremath{#1 \not\Leftarrow #2}}
...
% pattern marking
\newcommand{\ctxSynFixedIntoPat}[4]{\ensuremath{\withCtx{#1}{\synFixedInto{#2}{#3}{#4}}}}
\newcommand{\ctxAnaFixedIntoPat}[5]{\ensuremath{\withCtx{#1}{\anaFixedInto{#2}{#3}{#4 \dashv #5}}}}
...
% cursor
\newcommand{\ZCursor}[1]{\ensuremath{\mathcolorbox{cursorhighlight}{\textcolor{cursor}{\triangleright}#1\textcolor{cursor}{\triangleleft}}}}
